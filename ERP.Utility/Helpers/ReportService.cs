...
namespace ERP.Utility.Helpers
{
    public class ReportService
    {
        ...
        //    {
        //        var parameters = reportParameterCollection
        ...
        //    string mimeType;
        //    string extension;
        //    string format = exportType.ToUpper();
        ...
        //    // Render the report
        //    var resultBytes = report.Render(format);

        //    // Always set to inline view (browser display)
        //    var contentDisposition = new System.Net.Mime.ContentDisposition
        //    {
        //        FileName = $"{exportFileName}.{extension}",
        //        Inline = true  // Hardcoded to always display in browser first
        //    };
